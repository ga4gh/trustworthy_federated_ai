...
hosts="drs-central drs-site-1 drs-site-2 drs-site-3 drs-site-4"
...
# Train Object
curl --request POST \
  --url http://drs-site-1:4501/admin/ga4gh/drs/v1/objects \
...
# Train Object
curl --request POST \
  --url http://drs-site-2:4501/admin/ga4gh/drs/v1/objects \
  --header 'content-type: application/json' \
  --data '{
  "id": "site_b_train",
...
# Train Object
curl --request POST \
  --url http://drs-site-3:4501/admin/ga4gh/drs/v1/objects \
  --header 'content-type: application/json' \
  --data '{
  "id": "site_c_train",
...
# Train Object
curl --request POST \
  --url http://drs-site-4:4501/admin/ga4gh/drs/v1/objects \
  --header 'content-type: application/json' \
  --data '{
  "id": "site_d_train",
